<aside id="default-sidebar"
    class=" bg-[#1D546D] fixed top-18 left-0 z-40 w-64 h-full transition-transform -translate-x-full sm:translate-x-0"
    aria-label="Sidebar">
    <div class="h-full px-3 py-4 overflow-y-auto bg-neutral-primary-soft border-e border-default">
        <ul class="space-y-2 font-medium">
            <div
                class="bg-white rounded-md flex items-center px-2 py-1.5 text-body rounded-base hover:bg-neutral-tertiary hover:text-fg-brand group">
                <input name="search" aria-label="Search"
                    class="border-none outline-none bg-white adfp adfq adfw adgj adgx adhg adho adhs adhu adhv adib adie adig adii adin adiy adja adjc adjp">
                <svg viewBox="0 0 20 20" fill="currentColor" data-slot="icon" aria-hidden="true"
                    class="adfj adfp adfq adft adgb adgv adhz">
                    <path
