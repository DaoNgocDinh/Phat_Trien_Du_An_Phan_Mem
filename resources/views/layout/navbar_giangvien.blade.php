        ...
        <div class="flex h-16 items-center justify-between">
            ...
            <div class="flex items-center space-x-5 sm:space-x-6">
                ...
                <div class="relative inline-block text-left" id="notifDropdown">
                    ...
                    <div id="thongBaoMenu" class="hidden absolute right-0 mt-3 w-[400px] bg-white rounded-2xl shadow-2xl border border-gray-100 z-50 flex flex-col overflow-hidden transition-all origin-top-right">
                        ...
                        <div class="max-h-[60vh] overflow-y-auto bg-white" id="notif-list-container">
                            @forelse($danhSachThongBao as $tb)
                                ...
                                <a href="#" class="notif-item {{ $isNew ? 'is-unread' : '' }} flex items-start gap-4 p-4 border-b border-gray-50 hover:bg-gray-50 transition relative group">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <p class="text-[14px] text-gray-800 leading-snug">
                                            ...
                                            đã gửi một thông báo mới: <span class="font-bold text-gray-900">{{ $tb->TieuDe }}</span>.
                                        </p>
