            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <a href="{{ route('giangvien.detai.index') }}"
                       class="flex items-center px-3 py-2.5 text-white rounded-md hover:bg-[#2c5d6e] hover:shadow-md transition-all duration-200 
                       {{ request()->routeIs('giangvien.detai.index') ? 'bg-[#2c5d6e] shadow-md border-l-4 border-white text-white font-semibold' : '' }}">
                ...
                <li>
                    <a {{-- href="{{ route('giangvien.su-kien.index') }}" --}}
                       class="flex items-center px-3 py-2.5 text-white rounded-md hover:bg-[#2c5d6e] hover:shadow-md transition-all duration-200 
                       {{ request()->routeIs('giangvien.su-kien.*') ? 'bg-[#2c5d6e] shadow-md border-l-4 border-white text-white font-semibold' : '' }}">
                ...
                <li>
                    <a href="{{ route('giangvien.lienhe.index') }}"
                       class="flex items-center px-3 py-2.5 text-white rounded-md hover:bg-[#2c5d6e] hover:shadow-md transition-all duration-200 
                       {{ request()->routeIs('giangvien.lienhe.index') ? 'bg-[#2c5d6e] shadow-md border-l-4 border-white text-white font-semibold' : '' }}">
