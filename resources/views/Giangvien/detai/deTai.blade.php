                ...
                <table class="w-full divide-y divide-gray-200 text-center">
                    <thead
                        ...
                        <tr>
                            ...
                            <th class="px-6 py-4 text-center text-sm font-semibold uppercase tracking-wider">Tên đề tài
                            </th>
                            <th class="px-6 py-4 text-center text-sm font-semibold uppercase tracking-wider">Năm</th>
                            <th class="px-6 py-4 text-center text-sm font-semibold uppercase tracking-wider">Trạng thái
                            </th>
...
<div id="deTaiModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 hidden">
    <div class="bg-white rounded-xl shadow-2xl mx-4 relative overflow-hidden"
        style="border: 1px solid #000; width: 450px; max-width: calc(100% - 2rem);">
        <!-- Header -->
