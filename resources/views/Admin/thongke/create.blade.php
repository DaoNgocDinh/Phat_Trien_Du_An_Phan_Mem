    ...
    <div class="ml-64 p-8 pt-20 sm:ml-0">
        ...
        <div class="bg-[#EBF4F6] p-6 rounded-lg">
            ...
            <div class="grid grid-cols-2 gap-6 items-start">
                ...
                @else
                <div class="bg-white p-4 rounded-md shadow-sm py-7">
                    <div class="text-gray-600">Vui lòng nhập điều kiện lọc và nhấn Xem báo cáo để hiển thị biểu đồ và bảng.
                    </div>
                </div>
            @endif
            ...
            @else
                <div class="mt-6">
                    <div class="bg-white p-4 rounded-md shadow-sm">
                        <p class="text-gray-600">Vui lòng nhập điều kiện lọc và nhấn Xem báo cáo để hiển thị bảng.</p>
                    </div>
                </div>
            @endif
