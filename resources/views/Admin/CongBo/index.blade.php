            ...
            <div class="flex items-center justify-end">
                ...
                >
                    <span class="flex items-center justify-center w-7 h-7 rounded-md bg-white/30">
                        ...
                        <a
                            href="{{ route('admin.congbo.index', ['filter' => 'pending']) }}"
                            style="background:#3D99D7;"
                            class="inline-flex items-center gap-3 px-5 py-2 rounded-lg
                                text-white font-semibold shadow-sm
                                hover:brightness-95 transition text-xl"
                        >
                            <span class="flex items-center justify-center w-8 h-8 rounded bg-white/25">
                                <svg class="w-10 h-6 text-white"
                        ...
                        @forelse($congbos as $index => $item)
                            <tr class="hover:bg-gray-50 transition duration-150">
                                ...
                                <td class="px-4 py-4 text-center">
                                    ...
                                    @endphp
                                    <span style="{{ $style }} padding:4px 10px; border-radius:9999px; font-size:12px; font-weight:600; display:inline-block;">
                                        {{ $trangThai }}
                                    </span>
                                </td>
                                <td class="px-4 py-4">
