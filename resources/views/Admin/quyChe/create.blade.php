...
<div class="p-6 mt-16 ml-64">
    ...
    <form id="formQuyChe" method="POST" action="{{ route('admin.quyChe.store') }}" enctype="multipart/form-data"
        class="w-full mx-auto bg-white p-8 rounded-2xl shadow-lg border border-gray-200">
        @csrf

        <h2 class="text-2xl font-bold text-gray-800 mb-6">Đăng tải quy chế</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" name="MaQuyChe" value="{{ $MaQuyChe }}" readonly
            ...
            <div>
                ...
                <input type="text" name="SoHieu" value="{{ $SoHieu }}" readonly
                    class="w-full px-3 py-2 bg-gray-100 border border-gray-200 rounded-lg focus:outline-none">
            </div>
            ...
            <div class="md:col-span-2">
                ...
                <input type="text" name="TenVanBan" required
