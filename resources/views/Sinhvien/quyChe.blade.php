        ...
        <div class="max-w-[1400px] mx-auto">
            ...
            <div class="bg-white rounded-xl shadow overflow-hidden border border-gray-200">
                                ...
                                <tr class="hover:bg-gray-50 transition duration-150">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                        <div class="flex items-center justify-center gap-2">
                                            <button class="px-3 py-1.5 bg-blue-50 text-blue-600 rounded hover:bg-blue-100 font-semibold transition shadow-sm flex items-center gap-1"
                                                onclick="openModal(
                                            ...
                                            @if($quyche->FilePDF)
                                                <a href="{{ route('download.pdf', $quyche->FilePDF) ?? '#' }}" class="px-3 py-1.5 bg-green-50 text-green-600 rounded hover:bg-green-100 font-semibold transition shadow-sm flex items-center gap-1" title="Tải xuống PDF">
                ...
                <div class="px-6 py-4 border-t border-gray-200 flex flex-col sm:flex-row justify-between items-center text-sm text-gray-600 gap-4">
                    <div>
                        Hiển thị {{ $quyches->firstItem() }} - {{ $quyches->lastItem() }} trong {{ $quyches->total() }} quy chế
                    </div>
        ...
        <div class="bg-white rounded-xl shadow-2xl w-full max-w-2xl overflow-hidden flex flex-col max-h-[90vh]">
            ...
            <div class="p-6 overflow-y-auto space-y-5 text-gray-700">
                ...
                <div>
                    ...
                    <span id="modalLoaiVanBan" class="ml-2 inline-block bg-gray-100 text-gray-700 px-3 py-1 rounded-full text-sm font-semibold border border-gray-200"></span>
                </div>
            ...
            <div class="px-6 py-4 bg-gray-50 border-t border-gray-200 flex justify-end shrink-0 gap-3">
                <a id="modalDownloadBtn" href="#" class="px-6 py-2 bg-[#1D546D] text-white font-semibold rounded-lg hover:bg-[#154053] transition shadow-sm flex items-center gap-2 hidden">
